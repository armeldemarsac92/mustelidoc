...
Use normal server or cloud images for interactive console login. Fedora CoreOS, Trove, Magnum/Kubernetes, appliance, and cluster-node images are not the default choice for a normal interactive VM login flow.
