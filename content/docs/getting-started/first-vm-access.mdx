...
description: Associate a floating IP, find the generated DNS name, allow SSH, and connect through mustelinet SSH.
---

import { Globe2, Route, ShieldCheck, Terminal } from 'lucide-react';

To access the VM from outside the project network, associate a tenant floating IP and use the generated mustelinet route. Tenant SSH goes through mustelinet SSH. Do not SSH directly to the `10.50.0.0/24` floating IP address from the public internet.
