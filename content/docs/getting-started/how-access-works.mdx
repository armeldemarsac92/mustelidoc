...
description: Understand Skyline console access, generated DNS names, floating IPs, security groups, and mustelinet SSH.
---

import { Globe2, Monitor, Network, Route, ShieldCheck, Terminal } from 'lucide-react';
...
<Cards>
  <Card icon={<Monitor />} title="Console" href="/docs/access/console-access">
