...
If you only need dashboard console access, choose Login Type `Password` when creating the VM and use [Skyline console access](/docs/access/console-access) instead of creating a keypair.
